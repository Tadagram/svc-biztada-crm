...
const FALLBACK_DEMO_DATA = {
  sourceChannels: [
    { platform: 'TikTok', contentType: 'food_review', keywords: ['#tráicây', '#thựcphẩmsạch'], filterCriteria: '>15k views 7 ngày, <30 ngày tuổi', fetchFrequency: 'daily' },
  ],
  remakeDirection: 'Lấy video TikTok trending → Ghép footage kho + đóng gói thực tế → Thêm text overlay + CTA',
  contentVolume: '20-25 posts/tháng',
  autoSchedule: { contentPerWeek: 5, platforms: ['Facebook', 'Zalo OA', 'TikTok'], bestTimes: ['7h', '12h', '20h'], queueDays: 7 },
  seedingAfterPost: { commentWithinMinutes: 20, accountsPerPost: 5, replyToComments: true, commentTypes: ['Hỏi giao hàng', 'Khen chất lượng'], escalationHours: 4 },
  viralTriggers: ['Nếu >300 like trong 2h → boost thêm 100k 24h', 'Nếu comment >30 → seeder thêm 3 account trong 30 phút'],
  brandGuidelines: ['Không dùng nguyên video người khác — phải có footage kho/sản phẩm ≥40%', 'Logo góc dưới phải', 'Caption bắt đầu bằng pain point'],
  workflows: [
    {
      ...
      steps: [
        ...
        { step: 2, action: 'Hỏi nhu cầu 3 câu', tool: 'chatbot', timing: '1-3 phút', responsible: 'AI tự động' },
        { step: 3, action: 'Push vào CRM với tag nguồn', tool: 'crm', timing: 'ngay sau hội thoại', responsible: 'AI tự động' },
      ],
