  ...
  pipelineSteps: [
    {
      ...
      icon: '📡',
      color: '#10b981',
      label: 'Tổng hợp tài nguyên',
      sublabel: 'từ các kênh',
    ...
    },
    {
      ...
      icon: '🎯',
      color: '#f59e0b',
      label: 'Tiêm định hướng',
      sublabel: 'đặt điểm kênh',
    ...
    },
    {
      ...
      icon: '🤖',
      color: '#06b6d4',
      label: 'Remake tự động',
      sublabel: 'theo đặc tính kênh',
    ...
    {
      id: 'classify_distribute',
      step: 4,
      icon: '🗂️',
      color: '#8b5cf6',
      label: 'Phân loại danh mục',
      sublabel: 'phân bổ thư viện',
  ...
  hubChannels: [
    {
      ...
      emoji: '🛒',
      purpose:
        'Kênh chủ lực chuyển đổi — tập trung đơn hàng B2C nội địa Bình Dương, kéo khách cũ quay lại',
      trait:
        'Thân thiện, gần gũi, ngôn ngữ chị-em nội trợ. Không dùng thuật ngữ kỹ thuật. Ưu tiên hình ảnh thật, review thật.',
      ...
      contentFocus: [
        'Flash deal hàng mới nhập',
        'Review khách hàng thật (UGC)',
        'Hậu trường vận chuyển & kiểm hàng',
    ...
    },
    {
      ...
      emoji: '⚡',
      purpose:
        'Kênh viral & brand awareness — kéo nhận diện mới, tăng organic reach qua FYP cho nhóm trẻ healthy lifestyle',
      trait:
        'Năng động, vui, trendy. Dùng trend âm nhạc + effect. Format 9:16 ngắn 15–30s. Không cứng nhắc, không dài dòng.',
      ...
      contentFocus: [
        'Công thức sinh tố/nước ép từ sản phẩm PHF',
        'Challenge ăn lành 7 ngày',
        'Reaction hương vị trái cây theo mùa',
        'Behind the scene vườn đối tác',
      ],
    },
    {
      id: 'zalo_oa',
      ...
      emoji: '📨',
      purpose:
        'Kênh retention & repeat order — giữ chân khách cũ, đẩy đơn hàng định kỳ qua ZNS broadcast',
      trait:
        'Trực tiếp, ngắn gọn, rõ CTA. Mỗi tin nhắn phải có hành động cụ thể. Không dài dòng. Tần suất đúng — không spam.',
      ...
      contentFocus: [
        'ZNS hàng mới nhập tuần',
        'Combo deal cuối tuần với code giảm giá',
        'Nhắc đặt lại theo chu kỳ mua hàng',
        'Thông báo khuyến mãi VIP member',
      ],
    },
  ],
  seedingPersonas: [
    {
      ...
      behavior:
        'Share deal vào group mẹ, hỏi về nguồn gốc & chứng nhận an toàn thực phẩm, tag bạn trong comment đề xuất sản phẩm.',
      psychGoal:
        'Tạo cảm giác cộng đồng tin tưởng — lan tỏa qua mạng lưới mom-trust organic trong nhóm mẹ bỉm.',
    ...
    },
    {
      ...
      behavior:
        'Phân tích thành phần, độ sạch chứng chỉ organic. So sánh giá trị dinh dưỡng với đối thủ theo góc học thuật.',
      psychGoal:
        'Tạo trust tuyệt đối dựa trên góc nhìn khoa học — làm đám đông nghe theo ý kiến "chuyên gia".',
      traits: [40, 60, 90, 100, 95],
      waves: [
        'Wave 2 · 1–2h sau đăng',
        'Bình luận phân tích chuyên sâu',
        'So sánh với chuẩn quốc tế',
      ],
      sampleComment:
        '"Mình theo dõi PHF một thời gian, chỉ số vitamin C trong xoài cát HL của họ cao hơn thị trường 20–30%."',
    },
    {
      id: 'food_reviewer',
      label: 'Reviewer Thực Phẩm',
      icon: '📱',
      color: '#34d399',
      ratio: 23,
      cloneAccounts: 50,
      ...
      behavior:
        'Đánh giá hương vị thật, đăng ảnh review chân thực, so sánh giá thị trường, gợi ý combo.',
      psychGoal:
        'Khuếch đại UGC thật — content đáng tin dẫn thêm nhiều review thật từ cộng đồng thực.',
      traits: [70, 85, 65, 50, 75],
      waves: ['Wave 1+2 · 0–2h sau đăng', 'Ảnh unboxing + tasting', 'So sánh giá với siêu thị'],
      sampleComment:
        '"Vừa nhận đơn xoài cát HL, ngọt mà không gắt, size đều, giao nhanh — giá nhỉnh hơn chợ tí nhưng xứng đáng!"',
    },
    {
      id: 'healthy_youth',
      label: 'Thanh niên Healthy',
      icon: '💪',
      color: '#60a5fa',
      ratio: 18,
      cloneAccounts: 30,
      platform: 'TikTok',
      behavior:
        'Duet TikTok, trend healthy eating, tag bạn bè cùng thử công thức từ PHF, chia sẻ FYP.',
      psychGoal:
        'Viral qua FYP — kéo Gen Z organic reach bằng nội dung fun & relatable không lộ quảng cáo.',
