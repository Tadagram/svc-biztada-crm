...
const FALLBACK_DEMO_DATA = {
  features: [
    ...
    },
    {
      id: 'poster_plan',
      icon: '🗂️',
      label: 'Cụm Chủ Đề (Topics)',
      badge: 'ANCHOR CONTENT',
    ...
    },
    {
      id: 'matrix_details',
      icon: '🕸️',
      label: 'Matrix Tương Tác',
      badge: 'INTERACTION GRAPH',
  ...
  posterTopics: [
    {
      ...
      details:
        'Review trái cây thực tế, hình ảnh khách hàng nhận hàng, video đập hộp, phản hồi khen ngợi.',
    ...
    },
    {
      ...
      details:
        'Cách bảo quản trái cây, lợi ích sức khỏe, mẹo chọn quả ngon, thực đơn dinh dưỡng cho gia đình.',
    ...
    },
    {
      ...
      frequency: '2-3 bài/tuần',
      details:
        'Thực đơn ăn dặm từ trái cây cho bé, cách giúp trẻ lười ăn trái cây, câu chuyện làm mẹ bỉm.',
    ...
    },
    {
      ...
      details:
        'Cập nhật tình hình thời tiết, địa điểm vui chơi cuối tuần tại Thủ Dầu Một, mẹo vặt địa phương.',
      objective:
        'Kéo tương tác tự nhiên, định vị thương hiệu gắn bó sâu sát với cộng đồng địa phương.',
    ...
    },
    {
      ...
      frequency: '2-3 bài/tuần',
      details:
        'Mẹo ăn vặt không béo nơi công sở, sinh tố detox buổi sáng, set trái cây cắt sẵn văn phòng.',
      objective:
        'Mở rộng tệp khách hàng tiềm năng là dân văn phòng, tăng tần suất order hàng ngày.',
    ...
    },
    {
      ...
      frequency: '1-2 bài/tuần',
      details:
        'Flash deal giờ vàng, combo tiết kiệm cuối tuần, freeship, ưu đãi đặc quyền hội viên.',
  ...
  seedingMatrix: [
    ...
    {
      id: 'wave_2',
      name: 'Wave 2: Bồi đắp (Học hỏi & Đồng cảm)',
      time: '1–2 giờ sau',
      ratio: '30%',
    ...
    {
      id: 'wave_3',
      name: 'Wave 3: Kích động (Chốt sales)',
      time: '2–4 giờ sau',
      ratio: '20%',
