...
export const upsertFeaturesSchema: FastifySchema = {
  tags: ['Strategy Features'],
  summary: 'Create or update features slide data',
...
export const getFeaturesSchema: FastifySchema = {
  tags: ['Strategy Features'],
  summary: 'Get features/scenarios data for strategy app',
  description:
