...
const testCases = [
  {
    ...
    message: 'Tạo cho tôi một workflow tự động: Cào danh sách group facebook về, sau đó comment vào bài viết.'
  },
  {
    name: '🎯 BrandLabs Flow',
    message: 'Tạo cho tôi một nhân vật AI tên là Tony, nam giới, 25 tuổi, phong cách lịch lãm để làm KOL.'
  },
  {
    name: '🎯 Chatbot Flow',
    message: 'Tạo một kịch bản chatbot tên là "Báo Giá", tự động trả lời văn bản "Xin chào" khi khách gửi tin nhắn chứa từ khóa báo giá.'
  }
];
